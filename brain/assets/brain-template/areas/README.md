...
Ongoing responsibilities (no fixed "done" date). Each area is its own folder—add whatever areas make sense for you (e.g. work, health, learning).

- **Agent guidance:** See [AGENTS.md](AGENTS.md) for scope and conventions under this folder.
- Link to [projects](../projects/), [resources](../resources/), and [zettelkasten](../zettelkasten/) as needed.

## Standard for each area

**Each new area folder should contain:**
